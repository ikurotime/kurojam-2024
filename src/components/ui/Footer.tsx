...
export default function Footer() {
  return (
    <div className='mx-auto w-full max-w-screen-xl px-2.5 lg:px-20 relative z-10 overflow-hidden border border-b-0 border-primary-bg bg-black/50 pb-60 pt-16 backdrop-blur-lg md:rounded-t-2xl'>
